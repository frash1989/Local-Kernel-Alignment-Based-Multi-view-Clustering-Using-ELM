function [H_normalized,gamma,obj] = myregmultikernelclustering(K,cluster_count,M,lambda)
...
while flag
    ...
    %% [gamma]= updatekernelweights_cvx(H_normalized,K,H0,lambda);
    %% [gamma]= updatekernelweights(H_normalized,K,H0,lambda);
    %% [gamma,obj]= updatekernelweightsV2(T,K,HE0,lambda)
